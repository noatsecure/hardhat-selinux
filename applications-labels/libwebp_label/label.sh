...
/usr/sbin/semanage fcontext --add --type libwebp_lib_t /usr/lib/libwebp.so.7.1.2;
...
/usr/sbin/semanage fcontext --add --type libwebp_lib_t /usr/lib/libwebpdecoder.so.3.1.2;
...
/usr/sbin/semanage fcontext --add --type libwebp_lib_t /usr/lib/libwebpdemux.so.2.0.8;
...
/usr/sbin/semanage fcontext --add --type libwebp_lib_t /usr/lib/libwebpmux.so.3.0.7;
