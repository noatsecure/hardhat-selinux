#!/bin/sh
/usr/sbin/semanage fcontext --add --type gettext-libs_t /usr/lib/libasprintf.so.0.0.0;
...
/usr/sbin/semanage fcontext --add --type gettext-libs_t /usr/lib/libgettextpo.so.0.5.7;
