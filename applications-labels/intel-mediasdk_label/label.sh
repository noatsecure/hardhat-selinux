#!/bin/sh
/usr/sbin/semanage fcontext --add --type intel-mediasdk_lib_t /usr/lib/libmfx.so.1.34;
/usr/sbin/semanage fcontext --add --type intel-mediasdk_lib_t /usr/lib/libmfx.so.1;
/usr/sbin/semanage fcontext --add --type intel-mediasdk_lib_t /usr/lib/libmfxhw64.so.1.34;
