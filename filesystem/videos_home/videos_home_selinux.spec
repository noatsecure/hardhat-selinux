...
%post
semodule -n -i %{_datadir}/selinux/packages/videos_home.pp
...
%files
%attr(0600,root,root) %{_datadir}/selinux/packages/videos_home.pp
%{_datadir}/selinux/devel/include/contrib/videos_home.if
